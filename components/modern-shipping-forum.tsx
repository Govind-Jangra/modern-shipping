    ...
    <Card className="mb-6 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 border-none shadow-lg">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="flex space-x-2">
          ...
          />
          <Button type="submit" size="icon" className="bg-indigo-600 text-white hover:bg-indigo-700 transition-all duration-300 ease-in-out transform hover:scale-105" disabled={isLoading}>
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Card className="mt-4 bg-white/20 cursor-pointer hover:bg-white/30 transition-colors">
              <CardHeader>
                <CardTitle className="text-yellow-300">{selectedPost.title}</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <div className="mt-4">
                  ...
                  <ul className="list-disc list-inside">
                    {selectedPost.references.map((ref, i) => (
                      <li key={i} className="text-yellow-300 hover:underline cursor-pointer">{ref.title}</li>
                    ))}
                  </ul>
                </div>
              </CardContent>
...
const LiveDiscussions = () => {
  ...
  const [messages, setMessages] = useState([
    { id: 1, author: "ShippingPro", content: "Has anyone tried the new eco-friendly packaging from GreenBox?" },
    { id: 2, author: "LogisticsGuru", content: "I'm seeing a lot of delays with international shipments lately. Any tips?" },
    ...
    <Card className="bg-gray-800 border-gray-700">
      ...
      <CardContent>
        ...
        <form onSubmit={handleSendMessage} className="mt-4 flex">
          ...
          />
          <Button type="submit" className="ml-2 bg-yellow-500 text-gray-900 hover:bg-yellow-400">
            Send
          </Button>
        </form>
      </CardContent>
          ...
          <div key={index} className="flex items-center justify-between mb-4 last:mb-0">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{topic.discussions} discussions</p>
              </div>
            </div>
            <Dialog>
              <DialogTrigger asChild>
...
const ExpertCorner = () => {
  const experts = [
    {name: "Sarah Johnson", specialty: "International Logistics", isLive: true },
    {name: "Mike Chen", specialty: "Supply Chain Optimization", isLive: false },
          ...
          <div key={index} className="flex items-center justify-between mb-4 last:mb-0">
            <div className="flex items-center">
              <Avatar className="w-10 h-10 mr-3">
                <AvatarImage src={`https://api.dicebear.com/6.x/initials/svg?seed=${expert.name}`} alt={expert.name} />
            ...
            {expert.isLive ? (
              <Dialog>
                ...
                <DialogContent className="bg-gray-800 text-gray-100">
                  ...
                  <DialogFooter>
                    <Button onClick={() => setShowCamera(!showCamera)} className="bg-blue-500 text-white hover:bg-blue-600 mr-2">
              ...
              <Dialog>
                ...
                <DialogContent className="bg-gray-800 text-gray-100">
                  <DialogHeader>
                    <DialogTitle className="text-yellow-500">Schedule a Call with {expert.name}</DialogTitle>
                  </DialogHeader>
                  <div className="mt-4">
                    <p>Select a date and time to schedule a video call with {expert.name}:</p>
                    <Input type="datetime-local" className="mt-2 bg-gray-700 text-gray-100 border-gray-600" />
                  </div>
                  <DialogFooter>
                    <Button className="bg-yellow-500 text-gray-900 hover:bg-yellow-400">Confirm Booking</Button>
                  </DialogFooter>
                </DialogContent>
              </Dialog>
            )}
...
const VirtualEventSpace = () => {
  const events = [
    { title: "Future of Last-Mile Delivery", date: "June 15, 2023 at 2:00 PM EST" },
    { title: "Sustainability in Shipping", date: "June 18, 2023 at 11:00 AM EST" },
  ]
      ...
      <CardContent>
        <Tabs defaultValue="upcoming">
            ...
            {events.map((event, index) => (
              <div key={index} className="mb-4 last:mb-0">
                ...
                <Dialog>
                  ...
                  <DialogContent className="bg-gray-800 text-gray-100">
                    <DialogHeader>
                      <DialogTitle className="text-yellow-500">RSVP for {event.title}</DialogTitle>
                    </DialogHeader>
                    <p>Would you like to RSVP for {event.title} on {event.date}?</p>
                    <DialogFooter>
                      <Button className="bg-yellow-500 text-gray-900 hover:bg-yellow-400">Confirm RSVP</Button>
                    </DialogFooter>
                  </DialogContent>
                </Dialog>
              </div>
          ...
          <TabsContent value="live">
            <p className="text-gray-400">No live events at the moment. Check back soon!</p>
          </TabsContent>
        </Tabs>
      </CardContent>
    </Card>
...
const samplePosts = [
  ...
  },
  {
    ...
    content: "As a small e-commerce business, we're looking to transition to more sustainable packaging. What eco-friendly options have you found effective?",
    upvotes: 42,
    category: "Eco-Packaging",
    comments: [
      { id: 1, content: "We've had great success with compostable mailers for smaller items. Our customers love them!", author: "GreenShipper", date: "2023-06-18" },
      { id: 2, content: "Recycled cardboard boxes with water-activated paper tape have been our go-to for larger items.", author: "SustainableSender", date: "2023-06-19" }
    ],
  },
  {
    title: "Strategies for optimizing last-mile delivery",
    content: "Last-mile delivery costs are eating into our profits. What strategies have you implemented to optimize this part of the shipping process?",
    upvotes: 37,
    category: "Last-Mile Innovation",
    comments: [
      { id: 1, content: "We've partnered with local businesses to set up pickup points. It's reduced our costs significantly.", author: "InnovativeLogistics", date: "2023-06-20" },
      { id: 2, content: "Implementing route optimization software has helped us plan more efficient delivery routes.", author: "TechSavvyShipper", date: "2023-06-21" }
    ],
  },
  {
    title: "Improving delivery speed without breaking the bank",
    content: "Our customers are demanding faster shipping times, but expedited shipping is costly. How are you balancing speed and cost?",
    upvotes: 29,
    category: "Delivery Speed",
    comments: [
      { id: 1, content: "We've started using regional carriers for certain areas. They often offer faster delivery at lower costs.", author: "SpeedyShipper", date: "2023-06-22" },
      { id: 2, content: "Implementing a multi-warehouse strategy has helped us get products closer to customers before they even order.", author: "StrategicSender", date: "2023-06-23" }
    ],
  },
]
          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              <Link href="#" className="flex items-center space-x-2">
                ...
                <span className="text-2xl font-bold text-yellow-500">ShipTalk</span>
              </Link>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Button size="icon" variant="ghost" className="text-gray-300 hover:text-yellow-500">
              ...
              <Button size="icon" variant="ghost" className="md:hidden" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="pt-0">
                    <nav className="space-y-2">
                      <Button variant="ghost" className="w-full justify-start text-gray-300 hover:text-yellow-500 hover:bg-gray-700" onClick={() => setFilteredPosts(samplePosts)}>
                        <HomeIcon className="mr-2 h-4 w-4" />
                        All Posts
                      </Button>
                      <Button variant="ghost" className="w-full justify-start text-gray-300 hover:text-yellow-500 hover:bg-gray-700" onClick={() => handleTopicClick("Carrier Comparison")}>
                        <TruckIcon className="mr-2 h-4 w-4" />
                        Carrier Comparison
                      </Button>
                      <Button variant="ghost" className="w-full justify-start text-gray-300 hover:text-yellow-500 hover:bg-gray-700" onClick={() => handleTopicClick("Packaging")}>
                        <PackageIcon className="mr-2 h-4 w-4" />
                        Packaging
                      </Button>
                      <Button variant="ghost" className="w-full justify-start text-gray-300 hover:text-yellow-500 hover:bg-gray-700" onClick={() => handleTopicClick("Cost Optimization")}>
                        <DollarSignIcon className="mr-2 h-4 w-4" />
                        Cost Optimization
                      </Button>
                      <Button variant="ghost" className="w-full justify-start text-gray-300 hover:text-yellow-500 hover:bg-gray-700" onClick={() => handleTopicClick("Eco-Packaging")}>
                        <BoxIcon className="mr-2 h-4 w-4" />
                        Eco-Packaging
                      </Button>
                      <Button variant="ghost" className="w-full justify-start text-gray-300 hover:text-yellow-500 hover:bg-gray-700" onClick={() => handleTopicClick("Last-Mile Innovation")}>
                        <TruckIcon className="mr-2 h-4 w-4" />
                        Last-Mile Innovation
                      </Button>
                      <Button variant="ghost" className="w-full justify-start text-gray-300 hover:text-yellow-500 hover:bg-gray-700" onClick={() => handleTopicClick("Delivery Speed")}>
            ...
            <div className="lg:col-span-3 space-y-6">
              <div className="sticky top-24">
                <Card className="bg-gray-800 border-gray-700">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-gray-100">Create a Post</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <form className="space-y-4">
                      ...
                      />
                      <Button className="w-full bg-yellow-500 text-gray-900 hover:bg-yellow-400">Post</Button>
                    </form>
                  </CardContent>
                </Card>
                <div className="mt-6">
